...
class SetAgentDescription(CodedTool):
    ...
    async def async_invoke(self, args: dict[str, Any], sly_data: dict[str, Any]) -> str:
        ...
        proposed_network[the_agent_name]["description"] = new_description
        ...
        pending.setdefault(the_agent_name, {})["description"] = new_description

        logger.debug(">>>>>>>>>>>>>>>>>>> DONE %s !!!>>>>>>>>>>>>>>>>>>", self.__class__.__name__)
        return f"The description for '{the_agent_name}' has been staged successfully."
